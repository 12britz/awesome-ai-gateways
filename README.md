...
- [CoderPlan](https://coderplan.ai/#readme) - Unified LLM API gateway with OpenAI-compatible access to Claude, GPT, Gemini, DeepSeek, and 20+ models. Pay-per-use at ~0.7x official pricing. Hong Kong/Singapore nodes for low latency.
